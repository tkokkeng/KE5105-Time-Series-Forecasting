...
```{r}
res = aov(RMSE ~ method, data = results_long_df[results_long_df$lambda == .1, ])
summary(res)
```

The anova test found **insufficient evidence** to show that the differences are significant.
